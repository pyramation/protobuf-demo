// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/genutil/v1beta1/genesis.proto" (package "cosmos.genutil.v1beta1", syntax proto3),// tslint:disable
...
class GenesisState$Type extends MessageType<GenesisState> {
    constructor() {
        super("cosmos.genutil.v1beta1.GenesisState", [
            { no: 1, name: "gen_txs", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.jsontag": "gentxs", "gogoproto.casttype": "encoding/json.RawMessage" } }
        ]);
    }
