// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/distribution/v1beta1/tx.proto" (package "cosmos.distribution.v1beta1", syntax proto3),// tslint:disable
...
class MsgFundCommunityPool$Type extends MessageType<MsgFundCommunityPool> {
    constructor() {
        ...
        ], { "gogoproto.goproto_getters": false, "gogoproto.equal": false, "cosmos.msg.v1.signer": ["depositor"] });
    }
