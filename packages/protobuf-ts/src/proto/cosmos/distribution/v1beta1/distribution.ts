// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/distribution/v1beta1/distribution.proto" (package "cosmos.distribution.v1beta1", syntax proto3),// tslint:disable
...
class Params$Type extends MessageType<Params> {
    constructor() {
        super("cosmos.distribution.v1beta1.Params", [
            { no: 1, name: "community_tax", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Dec", "cosmos_proto.scalar": "cosmos.Dec" } },
            { no: 2, name: "base_proposer_reward", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Dec", "cosmos_proto.scalar": "cosmos.Dec" } },
            { no: 3, name: "bonus_proposer_reward", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Dec", "cosmos_proto.scalar": "cosmos.Dec" } },
...
class ValidatorHistoricalRewards$Type extends MessageType<ValidatorHistoricalRewards> {
    constructor() {
        super("cosmos.distribution.v1beta1.ValidatorHistoricalRewards", [
            { no: 1, name: "cumulative_reward_ratio", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => DecCoin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.DecCoins" } },
...
class ValidatorCurrentRewards$Type extends MessageType<ValidatorCurrentRewards> {
    ...
    create(value?: PartialMessage<ValidatorCurrentRewards>): ValidatorCurrentRewards {
        const message = { rewards: [], period: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class ValidatorSlashEvent$Type extends MessageType<ValidatorSlashEvent> {
    constructor() {
        super("cosmos.distribution.v1beta1.ValidatorSlashEvent", [
            { no: 1, name: "validator_period", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 2, name: "fraction", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Dec", "cosmos_proto.scalar": "cosmos.Dec" } }
        ]);
    }
    create(value?: PartialMessage<ValidatorSlashEvent>): ValidatorSlashEvent {
        const message = { validatorPeriod: 0n, fraction: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint64 validator_period */ 1:
                    message.validatorPeriod = reader.uint64().toBigInt();
                    break;
...
class ValidatorSlashEvents$Type extends MessageType<ValidatorSlashEvents> {
    constructor() {
        super("cosmos.distribution.v1beta1.ValidatorSlashEvents", [
            { no: 1, name: "validator_slash_events", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ValidatorSlashEvent, options: { "gogoproto.nullable": false } }
        ], { "gogoproto.goproto_stringer": false });
    }
...
class FeePool$Type extends MessageType<FeePool> {
    constructor() {
        super("cosmos.distribution.v1beta1.FeePool", [
            { no: 1, name: "community_pool", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => DecCoin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.DecCoins" } }
        ]);
    }
...
class DelegatorStartingInfo$Type extends MessageType<DelegatorStartingInfo> {
    constructor() {
        super("cosmos.distribution.v1beta1.DelegatorStartingInfo", [
            { no: 1, name: "previous_period", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 2, name: "stake", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Dec", "cosmos_proto.scalar": "cosmos.Dec" } },
            { no: 3, name: "height", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/, options: { "gogoproto.jsontag": "creation_height" } }
        ]);
    }
    create(value?: PartialMessage<DelegatorStartingInfo>): DelegatorStartingInfo {
        const message = { previousPeriod: 0n, stake: "", height: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint64 previous_period */ 1:
                    message.previousPeriod = reader.uint64().toBigInt();
                    break;
                case /* string stake */ 2:
