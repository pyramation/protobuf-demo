// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/distribution/v1beta1/genesis.proto" (package "cosmos.distribution.v1beta1", syntax proto3),// tslint:disable
...
class ValidatorOutstandingRewardsRecord$Type extends MessageType<ValidatorOutstandingRewardsRecord> {
    constructor() {
        super("cosmos.distribution.v1beta1.ValidatorOutstandingRewardsRecord", [
            { no: 1, name: "validator_address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 2, name: "outstanding_rewards", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => DecCoin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.DecCoins" } }
        ], { "gogoproto.goproto_getters": false, "gogoproto.equal": false });
    }
...
class ValidatorAccumulatedCommissionRecord$Type extends MessageType<ValidatorAccumulatedCommissionRecord> {
    constructor() {
        super("cosmos.distribution.v1beta1.ValidatorAccumulatedCommissionRecord", [
            { no: 1, name: "validator_address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 2, name: "accumulated", kind: "message", T: () => ValidatorAccumulatedCommission, options: { "gogoproto.nullable": false } }
        ], { "gogoproto.goproto_getters": false, "gogoproto.equal": false });
    }
...
class ValidatorHistoricalRewardsRecord$Type extends MessageType<ValidatorHistoricalRewardsRecord> {
    constructor() {
        super("cosmos.distribution.v1beta1.ValidatorHistoricalRewardsRecord", [
            ...
            { no: 3, name: "rewards", kind: "message", T: () => ValidatorHistoricalRewards, options: { "gogoproto.nullable": false } }
        ], { "gogoproto.goproto_getters": false, "gogoproto.equal": false });
    }
    create(value?: PartialMessage<ValidatorHistoricalRewardsRecord>): ValidatorHistoricalRewardsRecord {
        const message = { validatorAddress: "", period: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class ValidatorCurrentRewardsRecord$Type extends MessageType<ValidatorCurrentRewardsRecord> {
    constructor() {
        super("cosmos.distribution.v1beta1.ValidatorCurrentRewardsRecord", [
            { no: 1, name: "validator_address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 2, name: "rewards", kind: "message", T: () => ValidatorCurrentRewards, options: { "gogoproto.nullable": false } }
        ], { "gogoproto.goproto_getters": false, "gogoproto.equal": false });
    }
...
class DelegatorStartingInfoRecord$Type extends MessageType<DelegatorStartingInfoRecord> {
    constructor() {
        super("cosmos.distribution.v1beta1.DelegatorStartingInfoRecord", [
            ...
            { no: 3, name: "starting_info", kind: "message", T: () => DelegatorStartingInfo, options: { "gogoproto.nullable": false } }
        ], { "gogoproto.goproto_getters": false, "gogoproto.equal": false });
    }
...
class ValidatorSlashEventRecord$Type extends MessageType<ValidatorSlashEventRecord> {
    constructor() {
        super("cosmos.distribution.v1beta1.ValidatorSlashEventRecord", [
            ...
            { no: 3, name: "period", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 4, name: "validator_slash_event", kind: "message", T: () => ValidatorSlashEvent, options: { "gogoproto.nullable": false } }
        ], { "gogoproto.goproto_getters": false, "gogoproto.equal": false });
    }
    create(value?: PartialMessage<ValidatorSlashEventRecord>): ValidatorSlashEventRecord {
        const message = { validatorAddress: "", height: 0n, period: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class GenesisState$Type extends MessageType<GenesisState> {
    constructor() {
        super("cosmos.distribution.v1beta1.GenesisState", [
            ...
            { no: 2, name: "fee_pool", kind: "message", T: () => FeePool, options: { "gogoproto.nullable": false } },
            { no: 3, name: "delegator_withdraw_infos", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => DelegatorWithdrawInfo, options: { "gogoproto.nullable": false } },
            { no: 4, name: "previous_proposer", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 5, name: "outstanding_rewards", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ValidatorOutstandingRewardsRecord, options: { "gogoproto.nullable": false } },
            { no: 6, name: "validator_accumulated_commissions", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ValidatorAccumulatedCommissionRecord, options: { "gogoproto.nullable": false } },
            { no: 7, name: "validator_historical_rewards", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ValidatorHistoricalRewardsRecord, options: { "gogoproto.nullable": false } },
            { no: 8, name: "validator_current_rewards", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ValidatorCurrentRewardsRecord, options: { "gogoproto.nullable": false } },
            { no: 9, name: "delegator_starting_infos", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => DelegatorStartingInfoRecord, options: { "gogoproto.nullable": false } },
            { no: 10, name: "validator_slash_events", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ValidatorSlashEventRecord, options: { "gogoproto.nullable": false } }
        ], { "gogoproto.goproto_getters": false, "gogoproto.equal": false });
    }
