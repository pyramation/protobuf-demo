// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/distribution/v1beta1/query.proto" (package "cosmos.distribution.v1beta1", syntax proto3),// tslint:disable
...
class QueryValidatorSlashesRequest$Type extends MessageType<QueryValidatorSlashesRequest> {
    constructor() {
        super("cosmos.distribution.v1beta1.QueryValidatorSlashesRequest", [
            { no: 1, name: "validator_address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 2, name: "starting_height", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 3, name: "ending_height", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
    ...
    create(value?: PartialMessage<QueryValidatorSlashesRequest>): QueryValidatorSlashesRequest {
        const message = { validatorAddress: "", startingHeight: 0n, endingHeight: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class QueryDelegatorWithdrawAddressResponse$Type extends MessageType<QueryDelegatorWithdrawAddressResponse> {
    constructor() {
        super("cosmos.distribution.v1beta1.QueryDelegatorWithdrawAddressResponse", [
            { no: 1, name: "withdraw_address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } }
        ], { "gogoproto.goproto_getters": false, "gogoproto.equal": false });
    }
