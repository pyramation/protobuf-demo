// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/capability/v1beta1/genesis.proto" (package "cosmos.capability.v1beta1", syntax proto3),// tslint:disable
...
class GenesisOwners$Type extends MessageType<GenesisOwners> {
    constructor() {
        super("cosmos.capability.v1beta1.GenesisOwners", [
            ...
            { no: 2, name: "index_owners", kind: "message", T: () => CapabilityOwners, options: { "gogoproto.nullable": false } }
        ]);
    }
