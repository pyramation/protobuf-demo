// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/mint/v1beta1/mint.proto" (package "cosmos.mint.v1beta1", syntax proto3),// tslint:disable
...
class Minter$Type extends MessageType<Minter> {
    constructor() {
        super("cosmos.mint.v1beta1.Minter", [
            { no: 1, name: "inflation", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Dec", "cosmos_proto.scalar": "cosmos.Dec" } },
            { no: 2, name: "annual_provisions", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Dec", "cosmos_proto.scalar": "cosmos.Dec" } }
        ]);
    }
...
class Params$Type extends MessageType<Params> {
    constructor() {
        super("cosmos.mint.v1beta1.Params", [
            ...
            { no: 2, name: "inflation_rate_change", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Dec", "cosmos_proto.scalar": "cosmos.Dec" } },
            { no: 3, name: "inflation_max", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Dec", "cosmos_proto.scalar": "cosmos.Dec" } },
            { no: 4, name: "inflation_min", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Dec", "cosmos_proto.scalar": "cosmos.Dec" } },
            { no: 5, name: "goal_bonded", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Dec", "cosmos_proto.scalar": "cosmos.Dec" } },
            { no: 6, name: "blocks_per_year", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ], { "gogoproto.goproto_stringer": false });
    }
    create(value?: PartialMessage<Params>): Params {
        const message = { mintDenom: "", inflationRateChange: "", inflationMax: "", inflationMin: "", goalBonded: "", blocksPerYear: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint64 blocks_per_year */ 6:
                    message.blocksPerYear = reader.uint64().toBigInt();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
