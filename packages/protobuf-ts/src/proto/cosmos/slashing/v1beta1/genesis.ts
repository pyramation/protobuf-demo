// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/slashing/v1beta1/genesis.proto" (package "cosmos.slashing.v1beta1", syntax proto3),// tslint:disable
...
class GenesisState$Type extends MessageType<GenesisState> {
    constructor() {
        super("cosmos.slashing.v1beta1.GenesisState", [
            ...
            { no: 2, name: "signing_infos", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => SigningInfo, options: { "gogoproto.nullable": false } },
            { no: 3, name: "missed_blocks", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ValidatorMissedBlocks, options: { "gogoproto.nullable": false } }
        ]);
    }
...
class SigningInfo$Type extends MessageType<SigningInfo> {
    constructor() {
        super("cosmos.slashing.v1beta1.SigningInfo", [
            ...
            { no: 2, name: "validator_signing_info", kind: "message", T: () => ValidatorSigningInfo, options: { "gogoproto.nullable": false } }
        ]);
    }
...
class ValidatorMissedBlocks$Type extends MessageType<ValidatorMissedBlocks> {
    constructor() {
        super("cosmos.slashing.v1beta1.ValidatorMissedBlocks", [
            { no: 1, name: "address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 2, name: "missed_blocks", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => MissedBlock, options: { "gogoproto.nullable": false } }
        ]);
    }
...
class MissedBlock$Type extends MessageType<MissedBlock> {
    ...
    create(value?: PartialMessage<MissedBlock>): MissedBlock {
        const message = { index: 0n, missed: false };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
