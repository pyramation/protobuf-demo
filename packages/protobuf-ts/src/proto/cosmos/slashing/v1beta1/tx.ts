...
class MsgUnjail$Type extends MessageType<MsgUnjail> {
    constructor() {
        super("cosmos.slashing.v1beta1.MsgUnjail", [
            { no: 1, name: "validator_addr", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.jsontag": "address", "cosmos_proto.scalar": "cosmos.AddressString" } }
        ], { "gogoproto.goproto_getters": false, "gogoproto.goproto_stringer": true, "cosmos.msg.v1.signer": ["validator_addr"] });
    }
