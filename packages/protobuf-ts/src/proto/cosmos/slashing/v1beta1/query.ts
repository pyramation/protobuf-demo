// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/slashing/v1beta1/query.proto" (package "cosmos.slashing.v1beta1", syntax proto3),// tslint:disable
...
class QuerySigningInfoRequest$Type extends MessageType<QuerySigningInfoRequest> {
    constructor() {
        super("cosmos.slashing.v1beta1.QuerySigningInfoRequest", [
            { no: 1, name: "cons_address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } }
        ]);
    }
