// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/slashing/v1beta1/slashing.proto" (package "cosmos.slashing.v1beta1", syntax proto3),// tslint:disable
...
class ValidatorSigningInfo$Type extends MessageType<ValidatorSigningInfo> {
    constructor() {
        super("cosmos.slashing.v1beta1.ValidatorSigningInfo", [
            ...
            { no: 2, name: "start_height", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 3, name: "index_offset", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 4, name: "jailed_until", kind: "message", T: () => Timestamp, options: { "gogoproto.nullable": false, "gogoproto.stdtime": true } },
            { no: 5, name: "tombstoned", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 6, name: "missed_blocks_counter", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
    ...
    create(value?: PartialMessage<ValidatorSigningInfo>): ValidatorSigningInfo {
        const message = { address: "", startHeight: 0n, indexOffset: 0n, tombstoned: false, missedBlocksCounter: 0n };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 start_height */ 2:
                    message.startHeight = reader.int64().toBigInt();
                    break;
                case /* int64 index_offset */ 3:
                    message.indexOffset = reader.int64().toBigInt();
                    break;
                ...
                case /* int64 missed_blocks_counter */ 6:
                    message.missedBlocksCounter = reader.int64().toBigInt();
                    break;
                default:
...
class Params$Type extends MessageType<Params> {
    constructor() {
        super("cosmos.slashing.v1beta1.Params", [
            { no: 1, name: "signed_blocks_window", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 2, name: "min_signed_per_window", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Dec" } },
            { no: 3, name: "downtime_jail_duration", kind: "message", T: () => Duration, options: { "gogoproto.nullable": false, "gogoproto.stdduration": true } },
            { no: 4, name: "slash_fraction_double_sign", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Dec" } },
            { no: 5, name: "slash_fraction_downtime", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Dec" } }
        ]);
    }
    create(value?: PartialMessage<Params>): Params {
        const message = { signedBlocksWindow: 0n, minSignedPerWindow: new Uint8Array(0), slashFractionDoubleSign: new Uint8Array(0), slashFractionDowntime: new Uint8Array(0) };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int64 signed_blocks_window */ 1:
                    message.signedBlocksWindow = reader.int64().toBigInt();
                    break;
