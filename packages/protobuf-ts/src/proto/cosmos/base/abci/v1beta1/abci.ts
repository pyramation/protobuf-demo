// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/base/abci/v1beta1/abci.proto" (package "cosmos.base.abci.v1beta1", syntax proto3),// tslint:disable
...
export interface Result {
     ...
     *
     * @deprecated
     * @generated from protobuf field: bytes data = 1 [deprecated = true];
     */
    data: Uint8Array;
    /**
     ...
     *
     * @generated from protobuf field: repeated google.protobuf.Any msg_responses = 4;
     */
    msgResponses: Any[];
}
/**
...
export interface TxMsgData {
     ...
     *
     * @deprecated
     * @generated from protobuf field: repeated cosmos.base.abci.v1beta1.MsgData data = 1 [deprecated = true];
     */
    data: MsgData[];
    /**
     ...
     * Since: cosmos-sdk 0.46
     *
     * @generated from protobuf field: repeated google.protobuf.Any msg_responses = 2;
     */
    msgResponses: Any[];
}
/**
...
class TxResponse$Type extends MessageType<TxResponse> {
    constructor() {
        super("cosmos.base.abci.v1beta1.TxResponse", [
            ...
            { no: 9, name: "gas_wanted", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 10, name: "gas_used", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
    ...
    create(value?: PartialMessage<TxResponse>): TxResponse {
        const message = { height: 0n, txhash: "", codespace: "", code: 0, data: "", rawLog: "", logs: [], info: "", gasWanted: 0n, gasUsed: 0n, timestamp: "", events: [] };
...
class ABCIMessageLog$Type extends MessageType<ABCIMessageLog> {
    constructor() {
        super("cosmos.base.abci.v1beta1.ABCIMessageLog", [
            { no: 1, name: "msg_index", kind: "scalar", T: 13 /*ScalarType.UINT32*/, options: { "gogoproto.jsontag": "msg_index" } },
...
class Result$Type extends MessageType<Result> {
    constructor() {
        super("cosmos.base.abci.v1beta1.Result", [
            ...
            { no: 4, name: "msg_responses", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Any }
        ], { "gogoproto.goproto_getters": false });
    }
    create(value?: PartialMessage<Result>): Result {
        const message = { data: new Uint8Array(0), log: "", events: [], msgResponses: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Result): Result {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* bytes data = 1 [deprecated = true];*/ 1:
                ...
                case /* repeated tendermint.abci.Event events */ 3:
                    message.events.push(Event.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated google.protobuf.Any msg_responses */ 4:
...
class TxMsgData$Type extends MessageType<TxMsgData> {
    constructor() {
        super("cosmos.base.abci.v1beta1.TxMsgData", [
            ...
            { no: 2, name: "msg_responses", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Any }
        ], { "gogoproto.stringer": true });
    }
    create(value?: PartialMessage<TxMsgData>): TxMsgData {
        const message = { data: [], msgResponses: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: TxMsgData): TxMsgData {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated cosmos.base.abci.v1beta1.MsgData data = 1 [deprecated = true];*/ 1:
                    message.data.push(MsgData.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated google.protobuf.Any msg_responses */ 2:
                    message.msgResponses.push(Any.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
...
class SearchTxsResult$Type extends MessageType<SearchTxsResult> {
    constructor() {
        super("cosmos.base.abci.v1beta1.SearchTxsResult", [
            ...
            { no: 3, name: "page_number", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 4, name: "page_total", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
    ...
    create(value?: PartialMessage<SearchTxsResult>): SearchTxsResult {
        const message = { totalCount: 0n, count: 0n, pageNumber: 0n, pageTotal: 0n, limit: 0n, txs: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
