// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/base/tendermint/v1beta1/query.proto" (package "cosmos.base.tendermint.v1beta1", syntax proto3),// tslint:disable
...
export interface GetNodeInfoResponse {
    /**
     * @generated from protobuf field: tendermint.p2p.NodeInfo node_info = 1;
     */
    nodeInfo?: NodeInfo;
    /**
...
class GetValidatorSetByHeightResponse$Type extends MessageType<GetValidatorSetByHeightResponse> {
    constructor() {
        super("cosmos.base.tendermint.v1beta1.GetValidatorSetByHeightResponse", [
            { no: 1, name: "block_height", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
    ...
    create(value?: PartialMessage<GetValidatorSetByHeightResponse>): GetValidatorSetByHeightResponse {
        const message = { blockHeight: 0n, validators: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int64 block_height */ 1:
                    message.blockHeight = reader.int64().toBigInt();
                    break;
...
class Validator$Type extends MessageType<Validator> {
    constructor() {
        super("cosmos.base.tendermint.v1beta1.Validator", [
            ...
            { no: 3, name: "voting_power", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 4, name: "proposer_priority", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
    create(value?: PartialMessage<Validator>): Validator {
        const message = { address: "", votingPower: 0n, proposerPriority: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 voting_power */ 3:
                    message.votingPower = reader.int64().toBigInt();
                    break;
                case /* int64 proposer_priority */ 4:
                    message.proposerPriority = reader.int64().toBigInt();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
...
class GetNodeInfoResponse$Type extends MessageType<GetNodeInfoResponse> {
    constructor() {
        super("cosmos.base.tendermint.v1beta1.GetNodeInfoResponse", [
            { no: 1, name: "node_info", kind: "message", T: () => NodeInfo },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetNodeInfoResponse): GetNodeInfoResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* tendermint.p2p.NodeInfo node_info */ 1:
                    message.nodeInfo = NodeInfo.internalBinaryRead(reader, reader.uint32(), options, message.nodeInfo);
                    break;
    ...
    internalBinaryWrite(message: GetNodeInfoResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.nodeInfo)
            NodeInfo.internalBinaryWrite(message.nodeInfo, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
