// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/base/query/v1beta1/pagination.proto" (package "cosmos.base.query.v1beta1", syntax proto3),// tslint:disable
...
class PageRequest$Type extends MessageType<PageRequest> {
    ...
    create(value?: PartialMessage<PageRequest>): PageRequest {
        const message = { key: new Uint8Array(0), offset: 0n, limit: 0n, countTotal: false, reverse: false };
...
class PageResponse$Type extends MessageType<PageResponse> {
    ...
    create(value?: PartialMessage<PageResponse>): PageResponse {
        const message = { nextKey: new Uint8Array(0), total: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
