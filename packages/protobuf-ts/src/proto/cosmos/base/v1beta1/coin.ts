// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/base/v1beta1/coin.proto" (package "cosmos.base.v1beta1", syntax proto3),// tslint:disable
...
class Coin$Type extends MessageType<Coin> {
    constructor() {
        super("cosmos.base.v1beta1.Coin", [
            ...
            { no: 2, name: "amount", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "Int", "cosmos_proto.scalar": "cosmos.Int" } }
...
class DecCoin$Type extends MessageType<DecCoin> {
    constructor() {
        super("cosmos.base.v1beta1.DecCoin", [
            { no: 1, name: "denom", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "amount", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "Dec", "cosmos_proto.scalar": "cosmos.Dec" } }
        ], { "gogoproto.equal": true });
    }
...
class IntProto$Type extends MessageType<IntProto> {
    constructor() {
        super("cosmos.base.v1beta1.IntProto", [
            { no: 1, name: "int", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "Int", "cosmos_proto.scalar": "cosmos.Int" } }
        ]);
    }
...
class DecProto$Type extends MessageType<DecProto> {
    constructor() {
        super("cosmos.base.v1beta1.DecProto", [
            { no: 1, name: "dec", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "Dec", "cosmos_proto.scalar": "cosmos.Dec" } }
        ]);
    }
