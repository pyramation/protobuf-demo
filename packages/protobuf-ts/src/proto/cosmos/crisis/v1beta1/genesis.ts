// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/crisis/v1beta1/genesis.proto" (package "cosmos.crisis.v1beta1", syntax proto3),// tslint:disable
...
class GenesisState$Type extends MessageType<GenesisState> {
    constructor() {
        super("cosmos.crisis.v1beta1.GenesisState", [
            { no: 3, name: "constant_fee", kind: "message", T: () => Coin, options: { "gogoproto.nullable": false } }
        ]);
    }
