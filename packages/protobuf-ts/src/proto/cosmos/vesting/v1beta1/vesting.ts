// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/vesting/v1beta1/vesting.proto" (package "cosmos.vesting.v1beta1", syntax proto3),// tslint:disable
...
class BaseVestingAccount$Type extends MessageType<BaseVestingAccount> {
    constructor() {
        super("cosmos.vesting.v1beta1.BaseVestingAccount", [
            ...
            { no: 2, name: "original_vesting", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Coin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.Coins" } },
            { no: 3, name: "delegated_free", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Coin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.Coins" } },
            { no: 4, name: "delegated_vesting", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Coin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.Coins" } },
    ...
    create(value?: PartialMessage<BaseVestingAccount>): BaseVestingAccount {
        const message = { originalVesting: [], delegatedFree: [], delegatedVesting: [], endTime: 0n };
...
class Period$Type extends MessageType<Period> {
    constructor() {
        super("cosmos.vesting.v1beta1.Period", [
            { no: 1, name: "length", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
    ...
    create(value?: PartialMessage<Period>): Period {
        const message = { length: 0n, amount: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class PeriodicVestingAccount$Type extends MessageType<PeriodicVestingAccount> {
    constructor() {
        super("cosmos.vesting.v1beta1.PeriodicVestingAccount", [
            { no: 1, name: "base_vesting_account", kind: "message", T: () => BaseVestingAccount, options: { "gogoproto.embed": true } },
            { no: 2, name: "start_time", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 3, name: "vesting_periods", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Period, options: { "gogoproto.nullable": false } }
        ], { "gogoproto.goproto_getters": false, "gogoproto.goproto_stringer": false });
    }
    create(value?: PartialMessage<PeriodicVestingAccount>): PeriodicVestingAccount {
        const message = { startTime: 0n, vestingPeriods: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
