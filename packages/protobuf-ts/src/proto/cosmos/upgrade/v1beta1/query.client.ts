...
import type { QueryAuthorityResponse } from "./query";
import type { QueryAuthorityRequest } from "./query";
...
export interface IQueryClient {
     ...
     *
     * @generated from protobuf rpc: Authority(cosmos.upgrade.v1beta1.QueryAuthorityRequest) returns (cosmos.upgrade.v1beta1.QueryAuthorityResponse);
     */
    authority(input: QueryAuthorityRequest, options?: RpcOptions): UnaryCall<QueryAuthorityRequest, QueryAuthorityResponse>;
}
/**
 * Query defines the gRPC upgrade querier service.
 *
...
export class QueryClient implements IQueryClient, ServiceInfo {
    ...
    authority(input: QueryAuthorityRequest, options?: RpcOptions): UnaryCall<QueryAuthorityRequest, QueryAuthorityResponse> {
        ...
        return stackIntercept<QueryAuthorityRequest, QueryAuthorityResponse>("unary", this._transport, method, opt, input);
    }
}
