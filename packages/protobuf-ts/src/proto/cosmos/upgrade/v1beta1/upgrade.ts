// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/upgrade/v1beta1/upgrade.proto" (package "cosmos.upgrade.v1beta1", syntax proto3),// tslint:disable
...
class Plan$Type extends MessageType<Plan> {
    ...
    create(value?: PartialMessage<Plan>): Plan {
        const message = { name: "", height: 0n, info: "" };
