// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/upgrade/v1beta1/query.proto" (package "cosmos.upgrade.v1beta1", syntax proto3),// tslint:disable
 ...
 *
 * @generated from protobuf message cosmos.upgrade.v1beta1.QueryAuthorityRequest
 */
 ...
 * Since: cosmos-sdk 0.46
 *
 * @generated from protobuf message cosmos.upgrade.v1beta1.QueryAuthorityResponse
 */
...
class QueryUpgradedConsensusStateRequest$Type extends MessageType<QueryUpgradedConsensusStateRequest> {
    constructor() {
        super("cosmos.upgrade.v1beta1.QueryUpgradedConsensusStateRequest", [
            { no: 1, name: "last_height", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
    create(value?: PartialMessage<QueryUpgradedConsensusStateRequest>): QueryUpgradedConsensusStateRequest {
        const message = { lastHeight: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int64 last_height */ 1:
                    message.lastHeight = reader.int64().toBigInt();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
...
// @generated message type with reflection information, may provide speed optimized methods
class QueryAuthorityRequest$Type extends MessageType<QueryAuthorityRequest> {
    constructor() {
        super("cosmos.upgrade.v1beta1.QueryAuthorityRequest", []);
    }
    create(value?: PartialMessage<QueryAuthorityRequest>): QueryAuthorityRequest {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<QueryAuthorityRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: QueryAuthorityRequest): QueryAuthorityRequest {
        return target ?? this.create();
    }
    internalBinaryWrite(message: QueryAuthorityRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message cosmos.upgrade.v1beta1.QueryAuthorityRequest
 */
export const QueryAuthorityRequest = new QueryAuthorityRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class QueryAuthorityResponse$Type extends MessageType<QueryAuthorityResponse> {
    constructor() {
        super("cosmos.upgrade.v1beta1.QueryAuthorityResponse", [
            { no: 1, name: "address", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<QueryAuthorityResponse>): QueryAuthorityResponse {
        const message = { address: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<QueryAuthorityResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: QueryAuthorityResponse): QueryAuthorityResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: QueryAuthorityResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string address = 1; */
        if (message.address !== "")
...
/**
 * @generated MessageType for protobuf message cosmos.upgrade.v1beta1.QueryAuthorityResponse
 */
export const QueryAuthorityResponse = new QueryAuthorityResponse$Type();
/**
...
export const Query = new ServiceType("cosmos.upgrade.v1beta1.Query", [
    ...
    { name: "Authority", options: { "google.api.http": { get: "/cosmos/upgrade/v1beta1/authority" } }, I: QueryAuthorityRequest, O: QueryAuthorityResponse }
]);
