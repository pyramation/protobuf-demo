// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/tx/v1beta1/tx.proto" (package "cosmos.tx.v1beta1", syntax proto3),// tslint:disable
...
export interface SignDocDirectAux {
     ...
     *
     * @generated from protobuf field: cosmos.tx.v1beta1.Tip tip = 6;
     */
    tip?: Tip;
}
/**
...
export interface AuthInfo {
     ...
     * Since: cosmos-sdk 0.46
     *
     * @generated from protobuf field: cosmos.tx.v1beta1.Tip tip = 3;
     */
    tip?: Tip;
}
/**
...
class SignDoc$Type extends MessageType<SignDoc> {
    ...
    create(value?: PartialMessage<SignDoc>): SignDoc {
        const message = { bodyBytes: new Uint8Array(0), authInfoBytes: new Uint8Array(0), chainId: "", accountNumber: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
// @generated message type with reflection information, may provide speed optimized methods
class SignDocDirectAux$Type extends MessageType<SignDocDirectAux> {
    constructor() {
        super("cosmos.tx.v1beta1.SignDocDirectAux", [
            ...
            { no: 3, name: "chain_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "account_number", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 5, name: "sequence", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 6, name: "tip", kind: "message", T: () => Tip }
        ]);
    }
    create(value?: PartialMessage<SignDocDirectAux>): SignDocDirectAux {
        const message = { bodyBytes: new Uint8Array(0), chainId: "", accountNumber: 0n, sequence: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<SignDocDirectAux>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SignDocDirectAux): SignDocDirectAux {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* bytes body_bytes */ 1:
                    message.bodyBytes = reader.bytes();
                    break;
                case /* google.protobuf.Any public_key */ 2:
                ...
                case /* uint64 sequence */ 5:
                    ...
                    break;
                case /* cosmos.tx.v1beta1.Tip tip */ 6:
    ...
    internalBinaryWrite(message: SignDocDirectAux, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes body_bytes = 1; */
        if (message.bodyBytes.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.bodyBytes);
 ...
 */
export const SignDocDirectAux = new SignDocDirectAux$Type();
// @generated message type with reflection information, may provide speed optimized methods
class TxBody$Type extends MessageType<TxBody> {
    constructor() {
        super("cosmos.tx.v1beta1.TxBody", [
            ...
            { no: 3, name: "timeout_height", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
    ...
    create(value?: PartialMessage<TxBody>): TxBody {
        const message = { messages: [], memo: "", timeoutHeight: 0n, extensionOptions: [], nonCriticalExtensionOptions: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* cosmos.tx.v1beta1.Fee fee */ 2:
                    ...
                    break;
                case /* cosmos.tx.v1beta1.Tip tip */ 3:
                    message.tip = Tip.internalBinaryRead(reader, reader.uint32(), options, message.tip);
                    break;
                default:
                    let u = options.readUnknownField;
...
class Fee$Type extends MessageType<Fee> {
    constructor() {
        super("cosmos.tx.v1beta1.Fee", [
            ...
            { no: 3, name: "payer", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 4, name: "granter", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } }
        ]);
    }
    create(value?: PartialMessage<Fee>): Fee {
        const message = { amount: [], gasLimit: 0n, payer: "", granter: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class Tip$Type extends MessageType<Tip> {
    constructor() {
        super("cosmos.tx.v1beta1.Tip", [
            { no: 1, name: "amount", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Coin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.Coins" } },
            { no: 2, name: "tipper", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } }
        ]);
    }
    create(value?: PartialMessage<Tip>): Tip {
        const message = { amount: [], tipper: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
// @generated message type with reflection information, may provide speed optimized methods
class AuxSignerData$Type extends MessageType<AuxSignerData> {
    constructor() {
    ...
    create(value?: PartialMessage<AuxSignerData>): AuxSignerData {
        const message = { address: "", mode: 0, sig: new Uint8Array(0) };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<AuxSignerData>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: AuxSignerData): AuxSignerData {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* string address */ 1:
                    ...
                    break;
                case /* cosmos.tx.v1beta1.SignDocDirectAux sign_doc */ 2:
                    message.signDoc = SignDocDirectAux.internalBinaryRead(reader, reader.uint32(), options, message.signDoc);
                    break;
                case /* cosmos.tx.signing.v1beta1.SignMode mode */ 3:
                    message.mode = reader.int32();
                    break;
                case /* bytes sig */ 4:
    ...
    internalBinaryWrite(message: AuxSignerData, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string address = 1; */
        if (message.address !== "")
 ...
 */
export const AuxSignerData = new AuxSignerData$Type();
