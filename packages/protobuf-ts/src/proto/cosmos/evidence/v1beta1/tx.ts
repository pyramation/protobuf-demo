// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/evidence/v1beta1/tx.proto" (package "cosmos.evidence.v1beta1", syntax proto3),// tslint:disable
...
class MsgSubmitEvidence$Type extends MessageType<MsgSubmitEvidence> {
    constructor() {
        super("cosmos.evidence.v1beta1.MsgSubmitEvidence", [
            { no: 1, name: "submitter", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 2, name: "evidence", kind: "message", T: () => Any, options: { "cosmos_proto.accepts_interface": "Evidence" } }
        ], { "gogoproto.goproto_getters": false, "gogoproto.equal": false, "cosmos.msg.v1.signer": ["submitter"] });
    }
