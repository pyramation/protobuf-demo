// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/evidence/v1beta1/evidence.proto" (package "cosmos.evidence.v1beta1", syntax proto3),// tslint:disable
...
class Equivocation$Type extends MessageType<Equivocation> {
    constructor() {
        super("cosmos.evidence.v1beta1.Equivocation", [
            ...
            { no: 4, name: "consensus_address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } }
    ...
    create(value?: PartialMessage<Equivocation>): Equivocation {
        const message = { height: 0n, power: 0n, consensusAddress: "" };
