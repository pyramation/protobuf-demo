// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/crypto/multisig/keys.proto" (package "cosmos.crypto.multisig", syntax proto3),// tslint:disable
...
class LegacyAminoPubKey$Type extends MessageType<LegacyAminoPubKey> {
    constructor() {
        super("cosmos.crypto.multisig.LegacyAminoPubKey", [
            ...
            { no: 2, name: "public_keys", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Any, options: { "gogoproto.customname": "PubKeys" } }
