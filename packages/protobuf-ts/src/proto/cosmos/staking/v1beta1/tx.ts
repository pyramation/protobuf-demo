// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/staking/v1beta1/tx.proto" (package "cosmos.staking.v1beta1", syntax proto3),// tslint:disable
...
class MsgCreateValidator$Type extends MessageType<MsgCreateValidator> {
    constructor() {
        super("cosmos.staking.v1beta1.MsgCreateValidator", [
            ...
            { no: 3, name: "min_self_delegation", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Int", "cosmos_proto.scalar": "cosmos.Int" } },
            { no: 4, name: "delegator_address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 5, name: "validator_address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
        ...
        ], { "gogoproto.goproto_getters": false, "gogoproto.equal": false, "cosmos.msg.v1.signer": ["delegator_address", "validator_address"] });
    }
...
class MsgEditValidator$Type extends MessageType<MsgEditValidator> {
    constructor() {
        super("cosmos.staking.v1beta1.MsgEditValidator", [
            ...
            { no: 3, name: "commission_rate", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Dec", "cosmos_proto.scalar": "cosmos.Dec" } },
            { no: 4, name: "min_self_delegation", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Int", "cosmos_proto.scalar": "cosmos.Int" } }
        ], { "gogoproto.goproto_getters": false, "gogoproto.equal": false, "cosmos.msg.v1.signer": ["validator_address"] });
    }
...
class MsgDelegate$Type extends MessageType<MsgDelegate> {
    constructor() {
        ...
        ], { "gogoproto.goproto_getters": false, "gogoproto.equal": false, "cosmos.msg.v1.signer": ["delegator_address"] });
    }
