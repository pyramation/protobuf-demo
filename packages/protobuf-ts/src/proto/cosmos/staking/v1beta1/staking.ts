// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/staking/v1beta1/staking.proto" (package "cosmos.staking.v1beta1", syntax proto3),// tslint:disable
...
class CommissionRates$Type extends MessageType<CommissionRates> {
    constructor() {
        super("cosmos.staking.v1beta1.CommissionRates", [
            { no: 1, name: "rate", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Dec", "cosmos_proto.scalar": "cosmos.Dec" } },
            { no: 2, name: "max_rate", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Dec", "cosmos_proto.scalar": "cosmos.Dec" } },
            { no: 3, name: "max_change_rate", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Dec", "cosmos_proto.scalar": "cosmos.Dec" } }
...
class Commission$Type extends MessageType<Commission> {
    constructor() {
        super("cosmos.staking.v1beta1.Commission", [
            ...
            { no: 2, name: "update_time", kind: "message", T: () => Timestamp, options: { "gogoproto.nullable": false, "gogoproto.stdtime": true } }
        ], { "gogoproto.goproto_stringer": false, "gogoproto.equal": true });
    }
...
class Validator$Type extends MessageType<Validator> {
    constructor() {
        super("cosmos.staking.v1beta1.Validator", [
            { no: 1, name: "operator_address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 2, name: "consensus_pubkey", kind: "message", T: () => Any, options: { "cosmos_proto.accepts_interface": "cosmos.crypto.PubKey" } },
            ...
            { no: 5, name: "tokens", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Int", "cosmos_proto.scalar": "cosmos.Int" } },
            { no: 6, name: "delegator_shares", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Dec", "cosmos_proto.scalar": "cosmos.Dec" } },
            { no: 7, name: "description", kind: "message", T: () => Description, options: { "gogoproto.nullable": false } },
            { no: 8, name: "unbonding_height", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 9, name: "unbonding_time", kind: "message", T: () => Timestamp, options: { "gogoproto.nullable": false, "gogoproto.stdtime": true } },
            { no: 10, name: "commission", kind: "message", T: () => Commission, options: { "gogoproto.nullable": false } },
            { no: 11, name: "min_self_delegation", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Int", "cosmos_proto.scalar": "cosmos.Int" } }
    ...
    create(value?: PartialMessage<Validator>): Validator {
        const message = { operatorAddress: "", jailed: false, status: 0, tokens: "", delegatorShares: "", unbondingHeight: 0n, minSelfDelegation: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 unbonding_height */ 8:
                    message.unbondingHeight = reader.int64().toBigInt();
                    break;
...
class ValAddresses$Type extends MessageType<ValAddresses> {
    constructor() {
        super("cosmos.staking.v1beta1.ValAddresses", [
            { no: 1, name: "addresses", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } }
...
class DVPair$Type extends MessageType<DVPair> {
    constructor() {
        super("cosmos.staking.v1beta1.DVPair", [
            ...
            { no: 2, name: "validator_address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } }
        ], { "gogoproto.goproto_getters": false, "gogoproto.goproto_stringer": false, "gogoproto.equal": false });
    }
...
class DVVTriplet$Type extends MessageType<DVVTriplet> {
    constructor() {
        super("cosmos.staking.v1beta1.DVVTriplet", [
            { no: 1, name: "delegator_address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 2, name: "validator_src_address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 3, name: "validator_dst_address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } }
        ], { "gogoproto.goproto_getters": false, "gogoproto.goproto_stringer": false, "gogoproto.equal": false });
    }
...
class Delegation$Type extends MessageType<Delegation> {
    constructor() {
        super("cosmos.staking.v1beta1.Delegation", [
            { no: 1, name: "delegator_address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 2, name: "validator_address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 3, name: "shares", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Dec", "cosmos_proto.scalar": "cosmos.Dec" } }
        ], { "gogoproto.goproto_getters": false, "gogoproto.goproto_stringer": false, "gogoproto.equal": false });
    }
...
class UnbondingDelegationEntry$Type extends MessageType<UnbondingDelegationEntry> {
    constructor() {
        super("cosmos.staking.v1beta1.UnbondingDelegationEntry", [
            { no: 1, name: "creation_height", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 2, name: "completion_time", kind: "message", T: () => Timestamp, options: { "gogoproto.nullable": false, "gogoproto.stdtime": true } },
            { no: 3, name: "initial_balance", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Int", "cosmos_proto.scalar": "cosmos.Int" } },
            { no: 4, name: "balance", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Int", "cosmos_proto.scalar": "cosmos.Int" } }
        ], { "gogoproto.goproto_stringer": false, "gogoproto.equal": true });
    }
    create(value?: PartialMessage<UnbondingDelegationEntry>): UnbondingDelegationEntry {
        const message = { creationHeight: 0n, initialBalance: "", balance: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int64 creation_height */ 1:
                    message.creationHeight = reader.int64().toBigInt();
                    break;
...
class RedelegationEntry$Type extends MessageType<RedelegationEntry> {
    constructor() {
        super("cosmos.staking.v1beta1.RedelegationEntry", [
            ...
            { no: 2, name: "completion_time", kind: "message", T: () => Timestamp, options: { "gogoproto.nullable": false, "gogoproto.stdtime": true } },
            { no: 3, name: "initial_balance", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Int", "cosmos_proto.scalar": "cosmos.Int" } },
            { no: 4, name: "shares_dst", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Dec", "cosmos_proto.scalar": "cosmos.Dec" } }
        ], { "gogoproto.goproto_stringer": false, "gogoproto.equal": true });
    }
    create(value?: PartialMessage<RedelegationEntry>): RedelegationEntry {
        const message = { creationHeight: 0n, initialBalance: "", sharesDst: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class Params$Type extends MessageType<Params> {
    constructor() {
        super("cosmos.staking.v1beta1.Params", [
            { no: 1, name: "unbonding_time", kind: "message", T: () => Duration, options: { "gogoproto.nullable": false, "gogoproto.stdduration": true } },
            ...
            { no: 6, name: "min_commission_rate", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Dec", "gogoproto.moretags": "yaml:\"min_commission_rate\"" } }
        ], { "gogoproto.goproto_stringer": false, "gogoproto.equal": true });
    }
    create(value?: PartialMessage<Params>): Params {
        const message = { maxValidators: 0, maxEntries: 0, historicalEntries: 0, bondDenom: "", minCommissionRate: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string bond_denom */ 5:
                    ...
                    break;
                case /* string min_commission_rate */ 6:
    ...
    internalBinaryWrite(message: Params, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.minCommissionRate !== "")
            writer.tag(6, WireType.LengthDelimited).string(message.minCommissionRate);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class Pool$Type extends MessageType<Pool> {
    constructor() {
        super("cosmos.staking.v1beta1.Pool", [
            { no: 1, name: "not_bonded_tokens", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Int", "gogoproto.jsontag": "not_bonded_tokens", "cosmos_proto.scalar": "cosmos.Int" } },
            { no: 2, name: "bonded_tokens", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Int", "gogoproto.jsontag": "bonded_tokens", "cosmos_proto.scalar": "cosmos.Int" } }
