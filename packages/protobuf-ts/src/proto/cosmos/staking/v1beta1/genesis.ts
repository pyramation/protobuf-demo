// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/staking/v1beta1/genesis.proto" (package "cosmos.staking.v1beta1", syntax proto3),// tslint:disable
...
class GenesisState$Type extends MessageType<GenesisState> {
    constructor() {
        super("cosmos.staking.v1beta1.GenesisState", [
            ...
            { no: 2, name: "last_total_power", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Int" } },
            { no: 3, name: "last_validator_powers", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => LastValidatorPower, options: { "gogoproto.nullable": false } },
            ...
            { no: 6, name: "unbonding_delegations", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => UnbondingDelegation, options: { "gogoproto.nullable": false } },
...
class LastValidatorPower$Type extends MessageType<LastValidatorPower> {
    ...
    create(value?: PartialMessage<LastValidatorPower>): LastValidatorPower {
        const message = { address: "", power: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
