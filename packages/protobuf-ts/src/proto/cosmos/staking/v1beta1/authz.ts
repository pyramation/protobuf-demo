// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/staking/v1beta1/authz.proto" (package "cosmos.staking.v1beta1", syntax proto3),// tslint:disable
...
class StakeAuthorization_Validators$Type extends MessageType<StakeAuthorization_Validators> {
    constructor() {
        super("cosmos.staking.v1beta1.StakeAuthorization.Validators", [
            { no: 1, name: "address", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } }
        ]);
    }
