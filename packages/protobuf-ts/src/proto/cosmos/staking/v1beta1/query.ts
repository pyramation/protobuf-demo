...
class QueryValidatorRequest$Type extends MessageType<QueryValidatorRequest> {
    constructor() {
        super("cosmos.staking.v1beta1.QueryValidatorRequest", [
            { no: 1, name: "validator_addr", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } }
        ]);
    }
...
class QueryDelegationRequest$Type extends MessageType<QueryDelegationRequest> {
    constructor() {
        super("cosmos.staking.v1beta1.QueryDelegationRequest", [
            { no: 1, name: "delegator_addr", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 2, name: "validator_addr", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } }
...
class QueryRedelegationsRequest$Type extends MessageType<QueryRedelegationsRequest> {
    constructor() {
        super("cosmos.staking.v1beta1.QueryRedelegationsRequest", [
            { no: 1, name: "delegator_addr", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 2, name: "src_validator_addr", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 3, name: "dst_validator_addr", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
