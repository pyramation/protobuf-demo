// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/authz/v1beta1/event.proto" (package "cosmos.authz.v1beta1", syntax proto3),// tslint:disable
...
class EventGrant$Type extends MessageType<EventGrant> {
    constructor() {
        super("cosmos.authz.v1beta1.EventGrant", [
            ...
            { no: 3, name: "granter", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 4, name: "grantee", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } }
        ]);
    }
