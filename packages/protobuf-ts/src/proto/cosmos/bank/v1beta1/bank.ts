// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/bank/v1beta1/bank.proto" (package "cosmos.bank.v1beta1", syntax proto3),// tslint:disable
...
class Params$Type extends MessageType<Params> {
    constructor() {
        super("cosmos.bank.v1beta1.Params", [
            { no: 1, name: "send_enabled", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => SendEnabled },
...
class Input$Type extends MessageType<Input> {
    constructor() {
        ...
        ], { "gogoproto.goproto_getters": false, "gogoproto.equal": false, "cosmos.msg.v1.signer": ["address"] });
    }
...
class Supply$Type extends MessageType<Supply> {
    constructor() {
        ...
        ], { "gogoproto.goproto_getters": false, "gogoproto.equal": true, "cosmos_proto.implements_interface": ["*github.com/cosmos/cosmos-sdk/x/bank/migrations/v040.SupplyI"] });
    }
...
class Metadata$Type extends MessageType<Metadata> {
    constructor() {
        super("cosmos.bank.v1beta1.Metadata", [
            ...
            { no: 7, name: "uri", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customname": "URI" } },
            { no: 8, name: "uri_hash", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.customname": "URIHash" } }
        ]);
    }
    create(value?: PartialMessage<Metadata>): Metadata {
        const message = { description: "", denomUnits: [], base: "", display: "", name: "", symbol: "", uri: "", uriHash: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryWrite(message: Metadata, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* string uri_hash = 8; */
        if (message.uriHash !== "")
            writer.tag(8, WireType.LengthDelimited).string(message.uriHash);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
