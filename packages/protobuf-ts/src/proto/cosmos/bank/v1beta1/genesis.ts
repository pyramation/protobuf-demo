// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/bank/v1beta1/genesis.proto" (package "cosmos.bank.v1beta1", syntax proto3),// tslint:disable
...
class GenesisState$Type extends MessageType<GenesisState> {
    constructor() {
        super("cosmos.bank.v1beta1.GenesisState", [
            ...
            { no: 4, name: "denom_metadata", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Metadata, options: { "gogoproto.nullable": false } }
        ]);
    }
