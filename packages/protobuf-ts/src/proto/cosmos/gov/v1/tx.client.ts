...
import type { MsgExecLegacyContentResponse } from "./tx";
import type { MsgExecLegacyContent } from "./tx";
 ...
 *
 * @generated from protobuf service cosmos.gov.v1.Msg
 */
export interface IMsgClient {
    /**
     * SubmitProposal defines a method to create new proposal given a content.
     *
     * @generated from protobuf rpc: SubmitProposal(cosmos.gov.v1.MsgSubmitProposal) returns (cosmos.gov.v1.MsgSubmitProposalResponse);
     */
     ...
     *
     * @generated from protobuf rpc: ExecLegacyContent(cosmos.gov.v1.MsgExecLegacyContent) returns (cosmos.gov.v1.MsgExecLegacyContentResponse);
     */
    execLegacyContent(input: MsgExecLegacyContent, options?: RpcOptions): UnaryCall<MsgExecLegacyContent, MsgExecLegacyContentResponse>;
    /**
     * Vote defines a method to add a vote on a specific proposal.
     *
     * @generated from protobuf rpc: Vote(cosmos.gov.v1.MsgVote) returns (cosmos.gov.v1.MsgVoteResponse);
     */
    vote(input: MsgVote, options?: RpcOptions): UnaryCall<MsgVote, MsgVoteResponse>;
    /**
     * VoteWeighted defines a method to add a weighted vote on a specific proposal.
     *
     * @generated from protobuf rpc: VoteWeighted(cosmos.gov.v1.MsgVoteWeighted) returns (cosmos.gov.v1.MsgVoteWeightedResponse);
     */
    voteWeighted(input: MsgVoteWeighted, options?: RpcOptions): UnaryCall<MsgVoteWeighted, MsgVoteWeightedResponse>;
    /**
     * Deposit defines a method to add deposit on a specific proposal.
     *
     * @generated from protobuf rpc: Deposit(cosmos.gov.v1.MsgDeposit) returns (cosmos.gov.v1.MsgDepositResponse);
     */
...
export class MsgClient implements IMsgClient, ServiceInfo {
    ...
    execLegacyContent(input: MsgExecLegacyContent, options?: RpcOptions): UnaryCall<MsgExecLegacyContent, MsgExecLegacyContentResponse> {
        ...
        return stackIntercept<MsgExecLegacyContent, MsgExecLegacyContentResponse>("unary", this._transport, method, opt, input);
    }
    /**
     * Vote defines a method to add a vote on a specific proposal.
     *
