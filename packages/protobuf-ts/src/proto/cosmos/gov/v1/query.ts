// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/gov/v1/query.proto" (package "cosmos.gov.v1", syntax proto3),// tslint:disable
 ...
 *
 * @generated from protobuf message cosmos.gov.v1.QueryProposalRequest
 */
 ...
 *
 * @generated from protobuf message cosmos.gov.v1.QueryProposalsRequest
 */
export interface QueryProposalsRequest {
    /**
     * proposal_status defines the status of the proposals.
     *
     * @generated from protobuf field: cosmos.gov.v1.ProposalStatus proposal_status = 1;
     */
 ...
 *
 * @generated from protobuf message cosmos.gov.v1.QueryVoteRequest
 */
 ...
 *
 * @generated from protobuf message cosmos.gov.v1.QueryVoteResponse
 */
export interface QueryVoteResponse {
    /**
     * vote defined the queried vote.
     *
     * @generated from protobuf field: cosmos.gov.v1.Vote vote = 1;
     */
    vote?: Vote;
}
/**
 ...
 *
 * @generated from protobuf message cosmos.gov.v1.QueryVotesRequest
 */
 ...
 *
 * @generated from protobuf message cosmos.gov.v1.QueryParamsRequest
 */
...
export interface QueryParamsResponse {
     ...
     *
     * @generated from protobuf field: cosmos.gov.v1.VotingParams voting_params = 1;
     */
    votingParams?: VotingParams;
    /**
     * deposit_params defines the parameters related to deposit.
     *
     * @generated from protobuf field: cosmos.gov.v1.DepositParams deposit_params = 2;
     */
    depositParams?: DepositParams;
    /**
     * tally_params defines the parameters related to tally.
     *
     * @generated from protobuf field: cosmos.gov.v1.TallyParams tally_params = 3;
     */
 ...
 *
 * @generated from protobuf message cosmos.gov.v1.QueryDepositRequest
 */
 ...
 *
 * @generated from protobuf message cosmos.gov.v1.QueryDepositResponse
 */
export interface QueryDepositResponse {
    /**
     * deposit defines the requested deposit.
     *
     * @generated from protobuf field: cosmos.gov.v1.Deposit deposit = 1;
     */
    deposit?: Deposit;
}
/**
 ...
 *
 * @generated from protobuf message cosmos.gov.v1.QueryDepositsRequest
 */
 ...
 *
 * @generated from protobuf message cosmos.gov.v1.QueryTallyResultRequest
 */
...
class QueryProposalRequest$Type extends MessageType<QueryProposalRequest> {
    constructor() {
        super("cosmos.gov.v1.QueryProposalRequest", [
...
/**
 * @generated MessageType for protobuf message cosmos.gov.v1.QueryProposalRequest
 */
...
class QueryProposalResponse$Type extends MessageType<QueryProposalResponse> {
    constructor() {
        super("cosmos.gov.v1.QueryProposalResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: QueryProposalResponse): QueryProposalResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* cosmos.gov.v1.Proposal proposal */ 1:
    ...
    internalBinaryWrite(message: QueryProposalResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* cosmos.gov.v1.Proposal proposal = 1; */
        if (message.proposal)
...
class QueryProposalsRequest$Type extends MessageType<QueryProposalsRequest> {
    constructor() {
        super("cosmos.gov.v1.QueryProposalsRequest", [
            { no: 1, name: "proposal_status", kind: "enum", T: () => ["cosmos.gov.v1.ProposalStatus", ProposalStatus, "PROPOSAL_STATUS_"] },
            { no: 2, name: "voter", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 3, name: "depositor", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: QueryProposalsRequest): QueryProposalsRequest {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* cosmos.gov.v1.ProposalStatus proposal_status */ 1:
...
/**
 * @generated MessageType for protobuf message cosmos.gov.v1.QueryProposalsRequest
 */
...
class QueryProposalsResponse$Type extends MessageType<QueryProposalsResponse> {
    constructor() {
        super("cosmos.gov.v1.QueryProposalsResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: QueryProposalsResponse): QueryProposalsResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated cosmos.gov.v1.Proposal proposals */ 1:
...
class QueryVoteRequest$Type extends MessageType<QueryVoteRequest> {
    constructor() {
        super("cosmos.gov.v1.QueryVoteRequest", [
            { no: 1, name: "proposal_id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 2, name: "voter", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message cosmos.gov.v1.QueryVoteRequest
 */
...
class QueryVoteResponse$Type extends MessageType<QueryVoteResponse> {
    constructor() {
        super("cosmos.gov.v1.QueryVoteResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: QueryVoteResponse): QueryVoteResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* cosmos.gov.v1.Vote vote */ 1:
...
/**
 * @generated MessageType for protobuf message cosmos.gov.v1.QueryVoteResponse
 */
...
class QueryVotesRequest$Type extends MessageType<QueryVotesRequest> {
    constructor() {
        super("cosmos.gov.v1.QueryVotesRequest", [
            { no: 1, name: "proposal_id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
...
/**
 * @generated MessageType for protobuf message cosmos.gov.v1.QueryVotesRequest
 */
...
class QueryVotesResponse$Type extends MessageType<QueryVotesResponse> {
    constructor() {
        super("cosmos.gov.v1.QueryVotesResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: QueryVotesResponse): QueryVotesResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated cosmos.gov.v1.Vote votes */ 1:
    ...
    internalBinaryWrite(message: QueryVotesResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated cosmos.gov.v1.Vote votes = 1; */
...
class QueryParamsRequest$Type extends MessageType<QueryParamsRequest> {
    constructor() {
        super("cosmos.gov.v1.QueryParamsRequest", [
...
/**
 * @generated MessageType for protobuf message cosmos.gov.v1.QueryParamsRequest
 */
...
class QueryParamsResponse$Type extends MessageType<QueryParamsResponse> {
    constructor() {
        super("cosmos.gov.v1.QueryParamsResponse", [
...
class QueryDepositRequest$Type extends MessageType<QueryDepositRequest> {
    constructor() {
        super("cosmos.gov.v1.QueryDepositRequest", [
            { no: 1, name: "proposal_id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
    ...
    create(value?: PartialMessage<QueryDepositRequest>): QueryDepositRequest {
        const message = { proposalId: 0n, depositor: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
/**
 * @generated MessageType for protobuf message cosmos.gov.v1.QueryDepositRequest
 */
...
class QueryDepositResponse$Type extends MessageType<QueryDepositResponse> {
    constructor() {
        super("cosmos.gov.v1.QueryDepositResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: QueryDepositResponse): QueryDepositResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* cosmos.gov.v1.Deposit deposit */ 1:
    ...
    internalBinaryWrite(message: QueryDepositResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* cosmos.gov.v1.Deposit deposit = 1; */
        if (message.deposit)
...
/**
 * @generated MessageType for protobuf message cosmos.gov.v1.QueryDepositResponse
 */
...
class QueryDepositsRequest$Type extends MessageType<QueryDepositsRequest> {
    constructor() {
        super("cosmos.gov.v1.QueryDepositsRequest", [
            { no: 1, name: "proposal_id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 2, name: "pagination", kind: "message", T: () => PageRequest }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message cosmos.gov.v1.QueryDepositsRequest
 */
...
class QueryDepositsResponse$Type extends MessageType<QueryDepositsResponse> {
    constructor() {
        super("cosmos.gov.v1.QueryDepositsResponse", [
            { no: 1, name: "deposits", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Deposit },
            { no: 2, name: "pagination", kind: "message", T: () => PageResponse }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: QueryDepositsResponse): QueryDepositsResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated cosmos.gov.v1.Deposit deposits */ 1:
    ...
    internalBinaryWrite(message: QueryDepositsResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated cosmos.gov.v1.Deposit deposits = 1; */
...
class QueryTallyResultRequest$Type extends MessageType<QueryTallyResultRequest> {
    constructor() {
        super("cosmos.gov.v1.QueryTallyResultRequest", [
            { no: 1, name: "proposal_id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message cosmos.gov.v1.QueryTallyResultRequest
 */
...
class QueryTallyResultResponse$Type extends MessageType<QueryTallyResultResponse> {
    constructor() {
        super("cosmos.gov.v1.QueryTallyResultResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: QueryTallyResultResponse): QueryTallyResultResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* cosmos.gov.v1.TallyResult tally */ 1:
    ...
    internalBinaryWrite(message: QueryTallyResultResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* cosmos.gov.v1.TallyResult tally = 1; */
        if (message.tally)
...
/**
 * @generated ServiceType for protobuf service cosmos.gov.v1.Query
 */
export const Query = new ServiceType("cosmos.gov.v1.Query", [
    { name: "Proposal", options: { "google.api.http": { get: "/cosmos/gov/v1/proposals/{proposal_id}" } }, I: QueryProposalRequest, O: QueryProposalResponse },
    { name: "Proposals", options: { "google.api.http": { get: "/cosmos/gov/v1/proposals" } }, I: QueryProposalsRequest, O: QueryProposalsResponse },
    { name: "Vote", options: { "google.api.http": { get: "/cosmos/gov/v1/proposals/{proposal_id}/votes/{voter}" } }, I: QueryVoteRequest, O: QueryVoteResponse },
    { name: "Votes", options: { "google.api.http": { get: "/cosmos/gov/v1/proposals/{proposal_id}/votes" } }, I: QueryVotesRequest, O: QueryVotesResponse },
    { name: "Params", options: { "google.api.http": { get: "/cosmos/gov/v1/params/{params_type}" } }, I: QueryParamsRequest, O: QueryParamsResponse },
    { name: "Deposit", options: { "google.api.http": { get: "/cosmos/gov/v1/proposals/{proposal_id}/deposits/{depositor}" } }, I: QueryDepositRequest, O: QueryDepositResponse },
    { name: "Deposits", options: { "google.api.http": { get: "/cosmos/gov/v1/proposals/{proposal_id}/deposits" } }, I: QueryDepositsRequest, O: QueryDepositsResponse },
    { name: "TallyResult", options: { "google.api.http": { get: "/cosmos/gov/v1/proposals/{proposal_id}/tally" } }, I: QueryTallyResultRequest, O: QueryTallyResultResponse }
]);
