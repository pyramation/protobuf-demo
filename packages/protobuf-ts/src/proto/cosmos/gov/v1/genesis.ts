// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/gov/v1/genesis.proto" (package "cosmos.gov.v1", syntax proto3),// tslint:disable
 ...
 *
 * @generated from protobuf message cosmos.gov.v1.GenesisState
 */
export interface GenesisState {
     ...
     *
     * @generated from protobuf field: repeated cosmos.gov.v1.Deposit deposits = 2;
     */
    deposits: Deposit[];
    /**
     * votes defines all the votes present at genesis.
     *
     * @generated from protobuf field: repeated cosmos.gov.v1.Vote votes = 3;
     */
    votes: Vote[];
    /**
     * proposals defines all the proposals present at genesis.
     *
     * @generated from protobuf field: repeated cosmos.gov.v1.Proposal proposals = 4;
     */
    proposals: Proposal[];
    /**
     * params defines all the paramaters of related to deposit.
     *
     * @generated from protobuf field: cosmos.gov.v1.DepositParams deposit_params = 5;
     */
    depositParams?: DepositParams;
    /**
     * params defines all the paramaters of related to voting.
     *
     * @generated from protobuf field: cosmos.gov.v1.VotingParams voting_params = 6;
     */
    votingParams?: VotingParams;
    /**
     * params defines all the paramaters of related to tally.
     *
     * @generated from protobuf field: cosmos.gov.v1.TallyParams tally_params = 7;
     */
...
class GenesisState$Type extends MessageType<GenesisState> {
    constructor() {
        super("cosmos.gov.v1.GenesisState", [
            { no: 1, name: "starting_proposal_id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 2, name: "deposits", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Deposit },
            { no: 3, name: "votes", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Vote },
            { no: 4, name: "proposals", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Proposal },
    ...
    create(value?: PartialMessage<GenesisState>): GenesisState {
        const message = { startingProposalId: 0n, deposits: [], votes: [], proposals: [] };
...
/**
 * @generated MessageType for protobuf message cosmos.gov.v1.GenesisState
 */
