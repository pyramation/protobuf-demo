...
class MsgSubmitProposal$Type extends MessageType<MsgSubmitProposal> {
    constructor() {
        super("cosmos.gov.v1beta1.MsgSubmitProposal", [
            ...
            { no: 2, name: "initial_deposit", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Coin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.Coins" } },
            { no: 3, name: "proposer", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } }
        ], { "gogoproto.goproto_getters": false, "gogoproto.goproto_stringer": false, "gogoproto.stringer": false, "gogoproto.equal": false, "cosmos.msg.v1.signer": ["proposer"] });
    }
...
class MsgVote$Type extends MessageType<MsgVote> {
    constructor() {
        ...
        ], { "gogoproto.goproto_getters": false, "gogoproto.goproto_stringer": false, "gogoproto.stringer": false, "gogoproto.equal": false, "cosmos.msg.v1.signer": ["voter"] });
    }
    create(value?: PartialMessage<MsgVote>): MsgVote {
        const message = { proposalId: 0n, voter: "", option: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class MsgVoteWeighted$Type extends MessageType<MsgVoteWeighted> {
    ...
    create(value?: PartialMessage<MsgVoteWeighted>): MsgVoteWeighted {
        const message = { proposalId: 0n, voter: "", options: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class MsgDeposit$Type extends MessageType<MsgDeposit> {
    constructor() {
        ...
        ], { "gogoproto.goproto_getters": false, "gogoproto.goproto_stringer": false, "gogoproto.stringer": false, "gogoproto.equal": false, "cosmos.msg.v1.signer": ["depositor"] });
    }
