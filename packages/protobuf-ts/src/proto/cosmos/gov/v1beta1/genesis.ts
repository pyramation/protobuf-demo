// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/gov/v1beta1/genesis.proto" (package "cosmos.gov.v1beta1", syntax proto3),// tslint:disable
...
class GenesisState$Type extends MessageType<GenesisState> {
    constructor() {
        super("cosmos.gov.v1beta1.GenesisState", [
            ...
            { no: 5, name: "deposit_params", kind: "message", T: () => DepositParams, options: { "gogoproto.nullable": false } },
            { no: 6, name: "voting_params", kind: "message", T: () => VotingParams, options: { "gogoproto.nullable": false } },
            { no: 7, name: "tally_params", kind: "message", T: () => TallyParams, options: { "gogoproto.nullable": false } }
        ]);
    }
