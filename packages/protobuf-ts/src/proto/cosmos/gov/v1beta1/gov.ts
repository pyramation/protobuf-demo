// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/gov/v1beta1/gov.proto" (package "cosmos.gov.v1beta1", syntax proto3),// tslint:disable
...
class WeightedVoteOption$Type extends MessageType<WeightedVoteOption> {
    constructor() {
        super("cosmos.gov.v1beta1.WeightedVoteOption", [
            ...
            { no: 2, name: "weight", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Dec", "cosmos_proto.scalar": "cosmos.Dec" } }
        ]);
    }
...
class Proposal$Type extends MessageType<Proposal> {
    constructor() {
        super("cosmos.gov.v1beta1.Proposal", [
            ...
            { no: 3, name: "status", kind: "enum", T: () => ["cosmos.gov.v1beta1.ProposalStatus", ProposalStatus, "PROPOSAL_STATUS_"] },
            { no: 4, name: "final_tally_result", kind: "message", T: () => TallyResult, options: { "gogoproto.nullable": false } },
            { no: 5, name: "submit_time", kind: "message", T: () => Timestamp, options: { "gogoproto.nullable": false, "gogoproto.stdtime": true } },
            { no: 6, name: "deposit_end_time", kind: "message", T: () => Timestamp, options: { "gogoproto.nullable": false, "gogoproto.stdtime": true } },
            { no: 7, name: "total_deposit", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Coin, options: { "gogoproto.nullable": false, "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.Coins" } },
            { no: 8, name: "voting_start_time", kind: "message", T: () => Timestamp, options: { "gogoproto.nullable": false, "gogoproto.stdtime": true } },
            { no: 9, name: "voting_end_time", kind: "message", T: () => Timestamp, options: { "gogoproto.nullable": false, "gogoproto.stdtime": true } }
        ], { "gogoproto.equal": true });
    }
    create(value?: PartialMessage<Proposal>): Proposal {
        const message = { proposalId: 0n, status: 0, totalDeposit: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class TallyResult$Type extends MessageType<TallyResult> {
    constructor() {
        super("cosmos.gov.v1beta1.TallyResult", [
            { no: 1, name: "yes", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Int", "cosmos_proto.scalar": "cosmos.Int" } },
            { no: 2, name: "abstain", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Int", "cosmos_proto.scalar": "cosmos.Int" } },
            { no: 3, name: "no", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Int", "cosmos_proto.scalar": "cosmos.Int" } },
            { no: 4, name: "no_with_veto", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Int", "cosmos_proto.scalar": "cosmos.Int" } }
        ], { "gogoproto.equal": true });
    }
...
class Vote$Type extends MessageType<Vote> {
    constructor() {
        super("cosmos.gov.v1beta1.Vote", [
            { no: 1, name: "proposal_id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/, options: { "gogoproto.jsontag": "id" } },
    ...
    create(value?: PartialMessage<Vote>): Vote {
        const message = { proposalId: 0n, voter: "", option: 0, options: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class DepositParams$Type extends MessageType<DepositParams> {
    constructor() {
        super("cosmos.gov.v1beta1.DepositParams", [
            { no: 1, name: "min_deposit", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Coin, options: { "gogoproto.nullable": false, "gogoproto.jsontag": "min_deposit,omitempty", "gogoproto.castrepeated": "github.com/cosmos/cosmos-sdk/types.Coins" } },
            { no: 2, name: "max_deposit_period", kind: "message", T: () => Duration, options: { "gogoproto.nullable": false, "gogoproto.jsontag": "max_deposit_period,omitempty", "gogoproto.stdduration": true } }
        ]);
    }
...
class VotingParams$Type extends MessageType<VotingParams> {
    constructor() {
        super("cosmos.gov.v1beta1.VotingParams", [
            { no: 1, name: "voting_period", kind: "message", T: () => Duration, options: { "gogoproto.nullable": false, "gogoproto.jsontag": "voting_period,omitempty", "gogoproto.stdduration": true } }
        ]);
    }
...
class TallyParams$Type extends MessageType<TallyParams> {
    constructor() {
        super("cosmos.gov.v1beta1.TallyParams", [
            ...
            { no: 3, name: "veto_threshold", kind: "scalar", T: 12 /*ScalarType.BYTES*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "github.com/cosmos/cosmos-sdk/types.Dec", "gogoproto.jsontag": "veto_threshold,omitempty" } }
        ]);
    }
