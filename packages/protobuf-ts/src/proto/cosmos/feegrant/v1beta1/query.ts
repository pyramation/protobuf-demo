// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "cosmos/feegrant/v1beta1/query.proto" (package "cosmos.feegrant.v1beta1", syntax proto3),// tslint:disable
...
// @generated message type with reflection information, may provide speed optimized methods
class QueryAllowancesByGranterRequest$Type extends MessageType<QueryAllowancesByGranterRequest> {
    constructor() {
    ...
    create(value?: PartialMessage<QueryAllowancesByGranterRequest>): QueryAllowancesByGranterRequest {
        ...
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<QueryAllowancesByGranterRequest>(this, message, value);
        return message;
    }
...
// @generated message type with reflection information, may provide speed optimized methods
class QueryAllowancesByGranterResponse$Type extends MessageType<QueryAllowancesByGranterResponse> {
    constructor() {
    ...
    create(value?: PartialMessage<QueryAllowancesByGranterResponse>): QueryAllowancesByGranterResponse {
        ...
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<QueryAllowancesByGranterResponse>(this, message, value);
        return message;
    }
