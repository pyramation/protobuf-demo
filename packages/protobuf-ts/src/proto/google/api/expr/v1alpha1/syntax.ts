// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "google/api/expr/v1alpha1/syntax.proto" (package "google.api.expr.v1alpha1", syntax proto3),// tslint:disable
//
...
class Expr_CreateStruct_Entry$Type extends MessageType<Expr_CreateStruct_Entry> {
    ...
    create(value?: PartialMessage<Expr_CreateStruct_Entry>): Expr_CreateStruct_Entry {
        const message = { id: 0n, keyKind: { oneofKind: undefined } };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
