// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "tendermint/libs/bits/types.proto" (package "tendermint.libs.bits", syntax proto3),// tslint:disable
...
class BitArray$Type extends MessageType<BitArray> {
    constructor() {
        super("tendermint.libs.bits.BitArray", [
            { no: 1, name: "bits", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 2, name: "elems", kind: "scalar", repeat: 1 /*RepeatType.PACKED*/, T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
    create(value?: PartialMessage<BitArray>): BitArray {
        const message = { bits: 0n, elems: [] };
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: BitArray): BitArray {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int64 bits */ 1:
                    message.bits = reader.int64().toBigInt();
                    break;
                case /* repeated uint64 elems */ 2:
                    if (wireType === WireType.LengthDelimited)
                        for (let e = reader.int32() + reader.pos; reader.pos < e;)
                            message.elems.push(reader.uint64().toBigInt());
                    else
                        message.elems.push(reader.uint64().toBigInt());
                    break;
                default:
