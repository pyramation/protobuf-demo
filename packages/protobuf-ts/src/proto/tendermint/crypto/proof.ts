// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "tendermint/crypto/proof.proto" (package "tendermint.crypto", syntax proto3),// tslint:disable
...
class Proof$Type extends MessageType<Proof> {
    ...
    create(value?: PartialMessage<Proof>): Proof {
        const message = { total: 0n, index: 0n, leafHash: new Uint8Array(0), aunts: [] };
