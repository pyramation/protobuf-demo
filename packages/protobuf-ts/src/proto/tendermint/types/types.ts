// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "tendermint/types/types.proto" (package "tendermint.types", syntax proto3),// tslint:disable
...
class Vote$Type extends MessageType<Vote> {
    ...
    create(value?: PartialMessage<Vote>): Vote {
        const message = { type: 0, height: 0n, round: 0, validatorAddress: new Uint8Array(0), validatorIndex: 0, signature: new Uint8Array(0) };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class Commit$Type extends MessageType<Commit> {
    ...
    create(value?: PartialMessage<Commit>): Commit {
        const message = { height: 0n, round: 0, signatures: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class Proposal$Type extends MessageType<Proposal> {
    ...
    create(value?: PartialMessage<Proposal>): Proposal {
        const message = { type: 0, height: 0n, round: 0, polRound: 0, signature: new Uint8Array(0) };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class BlockMeta$Type extends MessageType<BlockMeta> {
    constructor() {
        super("tendermint.types.BlockMeta", [
            ...
            { no: 2, name: "block_size", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 3, name: "header", kind: "message", T: () => Header, options: { "gogoproto.nullable": false } },
            { no: 4, name: "num_txs", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
    create(value?: PartialMessage<BlockMeta>): BlockMeta {
        const message = { blockSize: 0n, numTxs: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 block_size */ 2:
                    message.blockSize = reader.int64().toBigInt();
                    break;
                case /* tendermint.types.Header header */ 3:
                    message.header = Header.internalBinaryRead(reader, reader.uint32(), options, message.header);
                    break;
                case /* int64 num_txs */ 4:
                    message.numTxs = reader.int64().toBigInt();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
