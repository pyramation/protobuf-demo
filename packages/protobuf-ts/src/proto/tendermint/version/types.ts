// @generated by protobuf-ts 2.4.0,// @generated from protobuf file "tendermint/version/types.proto" (package "tendermint.version", syntax proto3),// tslint:disable
...
class App$Type extends MessageType<App> {
    constructor() {
        super("tendermint.version.App", [
            { no: 1, name: "protocol", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 2, name: "software", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<App>): App {
        const message = { protocol: 0n, software: "" };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint64 protocol */ 1:
                    message.protocol = reader.uint64().toBigInt();
                    break;
...
class Consensus$Type extends MessageType<Consensus> {
    constructor() {
        super("tendermint.version.Consensus", [
            ...
            { no: 2, name: "app", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ], { "gogoproto.equal": true });
    }
    create(value?: PartialMessage<Consensus>): Consensus {
        const message = { block: 0n, app: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
